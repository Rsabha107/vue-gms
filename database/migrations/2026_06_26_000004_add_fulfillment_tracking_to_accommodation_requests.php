...
return new class extends Migration {
    public function up(): void
    {
        Schema::table('accommodation_requests', function (Blueprint $table) {
            ...
            $table->foreign('fulfilled_by_id')->references('id')->on('accommodation_requests')->nullOnDelete();
            $table->foreign('fulfills_request_id')->references('id')->on('accommodation_requests')->nullOnDelete();
        });
    }
