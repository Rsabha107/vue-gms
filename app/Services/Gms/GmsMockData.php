...
class GmsMockData
{
    ...
    {
        return [
            ['id' => 'M01', 'venueId' => 'V1', 'name' => 'Opening Ceremony',         'homeTeam' => 'Qatar',   'awayTeam' => null,        'date' => '2026-01-15', 'kickoff' => '19:00', 'stage' => 'Ceremony'],
            ['id' => 'M02', 'venueId' => 'V1', 'name' => 'Group A: Qatar vs Brazil', 'homeTeam' => 'Qatar',   'awayTeam' => 'Brazil',    'date' => '2026-01-18', 'kickoff' => '20:00', 'stage' => 'Group A'],
            ['id' => 'M03', 'venueId' => 'V1', 'name' => 'Group B: France vs Germany','homeTeam' => 'France', 'awayTeam' => 'Germany',   'date' => '2026-01-20', 'kickoff' => '20:00', 'stage' => 'Group B'],
            ['id' => 'M04', 'venueId' => 'V2', 'name' => 'Group A: Brazil vs Italy', 'homeTeam' => 'Brazil',  'awayTeam' => 'Italy',     'date' => '2026-01-23', 'kickoff' => '18:00', 'stage' => 'Group A'],
            ['id' => 'M05', 'venueId' => 'V1', 'name' => 'Quarter-Final 1',          'homeTeam' => 'TBD',     'awayTeam' => 'TBD',       'date' => '2026-02-08', 'kickoff' => '20:00', 'stage' => 'QF'],
            ['id' => 'M06', 'venueId' => 'V1', 'name' => 'Quarter-Final 2',          'homeTeam' => 'TBD',     'awayTeam' => 'TBD',       'date' => '2026-02-09', 'kickoff' => '20:00', 'stage' => 'QF'],
            ['id' => 'M07', 'venueId' => 'V1', 'name' => 'Semi-Final',               'homeTeam' => 'TBD',     'awayTeam' => 'TBD',       'date' => '2026-02-18', 'kickoff' => '20:00', 'stage' => 'SF'],
            ['id' => 'M08', 'venueId' => 'V1', 'name' => 'Final',                    'homeTeam' => 'TBD',     'awayTeam' => 'TBD',       'date' => '2026-02-28', 'kickoff' => '20:00', 'stage' => 'Final'],
        ];
    }
    ...
    {
        return [
            ['id' => 'FLT-001', 'guestId' => 'G002', 'guestName' => 'Emmanuel Macron',          'status' => 'confirmed', 'flightNo' => 'QR 2025', 'route' => 'CDG → DOH', 'origin' => 'CDG', 'destination' => 'DOH', 'class' => 'Business', 'pax' => 3, 'date' => '2026-01-14', 'time' => '09:30', 'arrival' => '2026-01-14', 'arrivalTime' => '18:45', 'notes' => 'Diplomatic passport, no queue'],
            ['id' => 'FLT-002', 'guestId' => 'G004', 'guestName' => 'Prince William',            'status' => 'confirmed', 'flightNo' => 'QR 5',    'route' => 'LHR → DOH', 'origin' => 'LHR', 'destination' => 'DOH', 'class' => 'First',    'pax' => 6, 'date' => '2026-01-14', 'time' => '21:00', 'arrival' => '2026-01-15', 'arrivalTime' => '07:00', 'notes' => 'Security pre-clear required'],
            ['id' => 'FLT-003', 'guestId' => 'G006', 'guestName' => 'Olaf Scholz',               'status' => 'confirmed', 'flightNo' => 'LH 688',  'route' => 'FRA → DOH', 'origin' => 'FRA', 'destination' => 'DOH', 'class' => 'Business', 'pax' => 4, 'date' => '2026-01-15', 'time' => '11:00', 'arrival' => '2026-01-15', 'arrivalTime' => '19:30', 'notes' => ''],
            ['id' => 'FLT-004', 'guestId' => 'G007', 'guestName' => 'Arsène Wenger',              'status' => 'pending',   'flightNo' => 'QR 47',   'route' => 'GVA → DOH', 'origin' => 'GVA', 'destination' => 'DOH', 'class' => 'Business', 'pax' => 2, 'date' => '2026-01-14', 'time' => '14:20', 'arrival' => '2026-01-14', 'arrivalTime' => '22:10', 'notes' => 'Awaiting confirmation'],
            ['id' => 'FLT-005', 'guestId' => 'G008', 'guestName' => 'Kylian Mbappé',              'status' => 'confirmed', 'flightNo' => 'QR 39',   'route' => 'CDG → DOH', 'origin' => 'CDG', 'destination' => 'DOH', 'class' => 'First',    'pax' => 2, 'date' => '2026-01-17', 'time' => '22:00', 'arrival' => '2026-01-18', 'arrivalTime' => '07:10', 'notes' => ''],
            ['id' => 'FLT-006', 'guestId' => 'G012', 'guestName' => 'Pedro Sánchez',              'status' => 'pending',   'flightNo' => 'IB 3168', 'route' => 'MAD → DOH', 'origin' => 'MAD', 'destination' => 'DOH', 'class' => 'Business', 'pax' => 3, 'date' => '2026-01-14', 'time' => '08:00', 'arrival' => '2026-01-14', 'arrivalTime' => '18:20', 'notes' => ''],
            ['id' => 'FLT-007', 'guestId' => 'G009', 'guestName' => 'Cristiano Ronaldo',          'status' => 'confirmed', 'flightNo' => 'QR 271',  'route' => 'RUH → DOH', 'origin' => 'RUH', 'destination' => 'DOH', 'class' => 'First',    'pax' => 1, 'date' => '2026-01-17', 'time' => '17:00', 'arrival' => '2026-01-17', 'arrivalTime' => '18:30', 'notes' => ''],
            ['id' => 'FLT-008', 'guestId' => 'G014', 'guestName' => 'Tim Cook',                   'status' => 'cancelled', 'flightNo' => 'AA 209',  'route' => 'JFK → DOH', 'origin' => 'JFK', 'destination' => 'DOH', 'class' => 'Business', 'pax' => 2, 'date' => '2026-01-13', 'time' => '22:30', 'arrival' => '2026-01-15', 'arrivalTime' => '05:55', 'notes' => 'Cancelled – rescheduled separately'],
        ];
    }
    ...
    public static function getAccommodationRequests(): array
    {
        return [
            ...
            ['id' => 'ACC-004', 'guestId' => 'G007', 'guestName' => 'Arsène Wenger',      'status' => 'pending',   'hotel' => 'HOT-06', 'hotelName' => 'InterContinental Doha', 'roomType' => 'Executive Suite',   'checkIn' => '2026-01-14', 'checkOut' => '2026-01-19', 'nights' => 5, 'notes' => 'Awaiting FIFA allocation confirmation'],
            ...
            ['id' => 'ACC-006', 'guestId' => 'G009', 'guestName' => 'Cristiano Ronaldo',  'status' => 'confirmed', 'hotel' => 'HOT-07', 'hotelName' => 'Waldorf Astoria Lusail','roomType' => 'Penthouse Suite',    'checkIn' => '2026-01-17', 'checkOut' => '2026-01-19', 'nights' => 2, 'notes' => ''],
            ['id' => 'ACC-007', 'guestId' => 'G012', 'guestName' => 'Pedro Sánchez',      'status' => 'pending',   'hotel' => 'HOT-01', 'hotelName' => 'Four Seasons Doha',      'roomType' => 'Diplomatic Suite',  'checkIn' => '2026-01-14', 'checkOut' => '2026-01-16', 'nights' => 2, 'notes' => ''],
